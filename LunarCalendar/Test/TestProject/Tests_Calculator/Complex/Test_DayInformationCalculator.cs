...
{
    internal class Test_DayInformationCalculator
    {
        IDayInformationCalculator calc;
        ...
        public void Setup()
        {
            ...
            calc = provider.GetRequiredService<IDayInformationCalculator>();
        }
        ...
        public void Test_2020_01_13()
        {
            ...
            var actual = calc.Calculate(parameters);
            var expected = Answers.Answers_DayInformation._2020_01_13;

            Answers.Answers_DayInformation.CompareDayInformation(actual, expected);
        }
        ...
        public void Test_2020_05_13()
        {
            ...
            var actual = calc.Calculate(parameters);
            var expected = Answers.Answers_DayInformation._2020_05_13;
        ...
        public void Test_2021_02_19()
        {
            ...
            var actual = calc.Calculate(parameters);
            var expected = Answers.Answers_DayInformation._2021_02_19;
